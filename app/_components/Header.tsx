...
import { PopoverButton, Popover, PopoverBackdrop, PopoverPanel } from '@headlessui/react'
  ...
  return (
    <li>
      <Link
        href={href}
        className={clsx(
          'relative block px-10 py-3 transition',
          isActive
...
function DesktopNavigation(props: React.ComponentPropsWithoutRef<'nav'>) {
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-5 text-sm font-medium text-zinc-800 shadow-lg ring-1 shadow-zinc-800/5 ring-zinc-900/5 backdrop-blur-sm dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
